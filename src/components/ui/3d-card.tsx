  ...
  (
    ...
    return (
      <motion.div
        ...
        className={cn(
          // Base styles for the card container, using a premium dark fallback background and thin border
          "mx-auto relative h-[26rem] w-full max-w-[20rem] rounded-2xl bg-slate-950 shadow-2xl border border-white/10 overflow-hidden",
          className
        )}
      >
        <div
